...
# Load the checkpoint.
model.m.load_weights("../lib/ResCNN_triplet_training_checkpoint_265.h5", by_name=True)
...
mfcc_001 = sample_from_mfcc(read_mfcc('../lib/wav48/p225/p225_001.wav', SAMPLE_RATE), NUM_FRAMES)
mfcc_002 = sample_from_mfcc(read_mfcc('../lib/wav48/p225/p225_002.wav', SAMPLE_RATE), NUM_FRAMES)
...
mfcc_003 = sample_from_mfcc(read_mfcc('../lib/wav48/p225/p225_003.wav', SAMPLE_RATE), NUM_FRAMES) # flac
